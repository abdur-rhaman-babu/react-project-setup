...
import { saveAppliedJobToLs } from "../../Utility/localstorage";
    ...
    <div className="mt-20 max-w-5xl mx-auto">
      ...
      <div className="lg:flex justify-between items-center gap-5 p-5">
        <div>
          ...
          <p className="font-normal text-xl mb-4">
            <span className="font-semibold"> Experiences:</span> {experiences}
          </p>
        </div>
        <div className="bg-blue-400 lg:w-2/5 p-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold pb-4 mb-4 border-b-2">
              Contact Information
            </h1>
            <div className="flex gap-1 items-center">
              <MdCall />
